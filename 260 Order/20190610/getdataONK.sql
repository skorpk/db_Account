...
DECLARE @dateStart DATETIME='20190101',	--всегда с начало года
		...
		@reportMonth TINYINT=5,--отчетный месяц ставим сами т.к. случаи отбираем с начало года
...
WHERE f.DateRegistration>@dateStart AND f.DateRegistration<@dateEnd AND a.ReportYear=@reportYear 
		...
		AND NOT EXISTS(SELECT 1 FROM dbo.t_260order_ONK WHERE rf_idCase=c.id) --AND c.id NOT IN(95663715,95663793,95713644) исключил данные случаи т.к. они январские и должны быть сняты из за не правильного оформления
