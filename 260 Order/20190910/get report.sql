...
SELECT f.CodeM,a.Account,c.GUID_Case,c.idRecordCase,IM_POL
FROM dbo.t_File f INNER JOIN dbo.t_RegistersAccounts a ON
			...
			r.id=c.rf_idRecordCasePatient
					INNER JOIN #t t ON
			c.GUID_Case=t.GUID_C                  
WHERE c.DateEnd>'20190701' AND f.DateRegistration>'20190701' AND a.rf_idSMO='34'
--select f.DateRegistration,f.TypeFile,f.id
...
--WHERE c.GUID_Case='9089F381-B823-3E06-E053-02057DC180F7' AND a.NumberRegister=476
GO
DROP TABLE #t