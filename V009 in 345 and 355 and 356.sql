...
from t_File f INNER JOIN dbo.t_RegistersAccounts a ON
		...
		c.id=d2.rf_idCase          
where f.DateRegistration>'20180321' AND a.Letter IN('O','R') AND c.rf_idV009 IN(345,355,356) AND (ISNULL(c.IsNeedDisp,0)<1 and ISNULL(d2.IsNeedDisp,0)<1)
		AND a.rf_idSMO='34007'
