...
INSERT #tNameCol(id,Name) VALUES(1,'Болезни системы кровообращения'),(2,'Злокачественные новообразования'),(3,'Болезни органов дыхания'),(4,'Болезни системы пищеварения'),(5,'Болезни эндокринной системы'),(6,' в том числе "Сахарный диабет"')
...
SELECT c.id AS rf_idCase, c.AmountPayment,f.CodeM,p.ENP,pp.BirthDay,CAST(NULL AS VARCHAR(10)) AS rf_idV025,d.idRow, c.rf_idV006 AS USL_OK,d.MainDS,c.rf_idRecordCasePatient
	,CASE WHEN c.Age>17 THEN 'Взрослые' ELSE 'Дети' END AS VozrastGroup
INTO #tCases
