...
FROM dbo.t_File f INNER JOIN dbo.t_RegistersAccounts a ON
			...
			c.id=dd.rf_idCase						
WHERE f.DateRegistration>=@dateStartReg AND f.DateRegistration<@dateEndReg  AND a.ReportYear=@reportYear AND c.AmountPayment>0  AND a.ReportMonth=@reportMonth --AND f.CodeM='101302'
...
FROM dbo.t_File f INNER JOIN dbo.t_RegistersAccounts a ON
			...
			c.id=dd.rf_idCase	
WHERE f.DateRegistration>=@dateStartReg AND f.DateRegistration<@dateEndReg  AND a.ReportYear=@reportYear AND c.AmountPayment=0.0 AND c.rf_idV006=4 AND a.ReportMonth=@reportMonth --AND f.CodeM='101302'
...
FROM dbo.t_File f INNER JOIN dbo.t_RegistersAccounts a ON
			...
			r.id=c.rf_idRecordCasePatient	
					INNER JOIN dbo.t_CompletedCase cc ON
            r.id=cc.rf_idRecordCasePatient
WHERE f.DateRegistration>='20191205' AND f.DateRegistration<'20200120'  AND a.ReportYear=2019 AND a.ReportMonth=12 AND a.rf_idSMO<>'34' --AND f.CodeM='101302'
...
FROM dbo.t_File f INNER JOIN dbo.t_RegistersAccounts a ON
			...
			r.id=c.rf_idRecordCasePatient	
					INNER JOIN dbo.t_CompletedCase cc ON
            r.id=cc.rf_idRecordCasePatient				
WHERE f.DateRegistration>='20200118' AND f.DateRegistration<'20200311'  AND a.ReportYear=2020 AND a.ReportMonth<3  AND a.rf_idSMO<>'34'-- AND f.CodeM='101302'
-----------------------------------------------------------------------------------------------------
...
FROM dbo.t_File f INNER JOIN dbo.t_RegistersAccounts a ON
            ...
            r.id=cc.rf_idRecordCasePatient
					INNER JOIN dbo.t_Diagnosis dd ON
			c.id=dd.rf_idCase						
WHERE f.DateRegistration>='20191205' AND f.DateRegistration<'20200120'  AND a.ReportYear=2019  AND a.ReportMonth=12 AND dd.TypeDiagnosis IN(1,3) --AND f.CodeM='101302'
...
FROM dbo.t_File f INNER JOIN dbo.t_RegistersAccounts a ON
            ...
            r.id=cc.rf_idRecordCasePatient
					INNER JOIN dbo.t_Diagnosis dd ON
			c.id=dd.rf_idCase						
WHERE f.DateRegistration>='20200118' AND f.DateRegistration<'20200311'  AND a.ReportYear=2020 AND a.ReportMonth<3 AND dd.TypeDiagnosis IN(1,3) --AND f.CodeM='101302'
		AND EXISTS(SELECT 1 FROM #tDiag d WHERE d.DiagnosisCode=dd.DiagnosisCode AND dd.TypeDiagnosis=REPLACE(d.TypeDiag,2,3)) AND a.rf_idSMO<>'34'
...
INSERT #total SELECT 22,CodeM,SUM(AmountPayment) AS Col2, ReportMonth ,0.0 AS Col1,0.0 AS Col1_1  FROM (SELECT DISTINCT id,CodeM,AmountPayment,ReportMonth,USL_OK,rf_idV002,Col_60_3,For_POM,IsOnk FROM  #tCases) t WHERE ReportMonth=@reportMonth and USL_OK=1  AND (rf_idV002 not IN(18,60,76) And (t.rf_idV002<>12 OR IsOnk IS NULL)) AND FOR_POM=1 GROUP BY CodeM,ReportMonth
INSERT #total SELECT 23,CodeM,SUM(AmountPayment) AS Col2, ReportMonth ,0.0 AS Col1,0.0 AS Col1_1  FROM (SELECT DISTINCT id,CodeM,AmountPayment,ReportMonth,USL_OK,rf_idV002,Col_60_3,For_POM,IsOnk FROM  #tCases) t WHERE ReportMonth=@reportMonth and USL_OK=1  AND (rf_idV002 not IN(18,60,76) And (t.rf_idV002<>12 OR IsOnk IS NULL)) AND FOR_POM=3 GROUP BY CodeM,ReportMonth
...
INSERT #total SELECT 22,CodeM,0.0 AS Col2, 1 as ReportMonth,SUM(AmountPayment) AS Col1,0.0 AS Col1_1  FROM (SELECT DISTINCT id,CodeM,AmountPayment,ReportMonth,USL_OK,rf_idV002,Col_60_3,For_POM,IsOnk FROM  #tCases) t WHERE ReportMonth<>@reportMonth and USL_OK=1 AND (rf_idV002 not IN(18,60,76) And (t.rf_idV002<>12 OR IsOnk IS NULL)) AND FOR_POM=1 GROUP BY CodeM
INSERT #total SELECT 23,CodeM,0.0 AS Col2, 1 as ReportMonth,SUM(AmountPayment) AS Col1,0.0 AS Col1_1  FROM (SELECT DISTINCT id,CodeM,AmountPayment,ReportMonth,USL_OK,rf_idV002,Col_60_3,For_POM,IsOnk FROM  #tCases) t WHERE ReportMonth<>@reportMonth and USL_OK=1 AND (rf_idV002 not IN(18,60,76) And (t.rf_idV002<>12 OR IsOnk IS NULL)) AND FOR_POM=3 GROUP BY CodeM
