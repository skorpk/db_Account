...
INSERT #total SELECT 22,CodeM,SUM(AmountPayment) AS Col2, ReportMonth ,0.0 AS Col1,0.0 AS Col1_1  FROM (SELECT DISTINCT id,CodeM,AmountPayment,ReportMonth,USL_OK,rf_idV002,Col_60_3,For_POM,IsOnk FROM  #tCases) t WHERE ReportMonth=@reportMonth and USL_OK=1  AND (rf_idV002 not IN(18,60,76) OR IsOnk IS null) AND FOR_POM=1 GROUP BY CodeM,ReportMonth
INSERT #total SELECT 23,CodeM,SUM(AmountPayment) AS Col2, ReportMonth ,0.0 AS Col1,0.0 AS Col1_1  FROM (SELECT DISTINCT id,CodeM,AmountPayment,ReportMonth,USL_OK,rf_idV002,Col_60_3,For_POM,IsOnk FROM  #tCases) t WHERE ReportMonth=@reportMonth and USL_OK=1  AND (rf_idV002 not IN(18,60,76) OR IsOnk IS null) AND FOR_POM=3 GROUP BY CodeM,ReportMonth
...
INSERT #total SELECT 22,CodeM,0.0 AS Col2, 1 as ReportMonth,SUM(AmountPayment) AS Col1,0.0 AS Col1_1  FROM (SELECT DISTINCT id,CodeM,AmountPayment,ReportMonth,USL_OK,rf_idV002,Col_60_3,For_POM,IsOnk FROM  #tCases) t WHERE ReportMonth<>@reportMonth and USL_OK=1 AND (rf_idV002 not IN(18,60,76) OR IsOnk IS null) AND FOR_POM=1 GROUP BY CodeM
INSERT #total SELECT 23,CodeM,0.0 AS Col2, 1 as ReportMonth,SUM(AmountPayment) AS Col1,0.0 AS Col1_1  FROM (SELECT DISTINCT id,CodeM,AmountPayment,ReportMonth,USL_OK,rf_idV002,Col_60_3,For_POM,IsOnk FROM  #tCases) t WHERE ReportMonth<>@reportMonth and USL_OK=1 AND (rf_idV002 not IN(18,60,76) OR IsOnk IS null) AND FOR_POM=3 GROUP BY CodeM
