...
SELECT rf_idCase, AmountPayment, ENP, ReportMonth, ReportYear, IdTypeCol12,@dd AS dd INTO #t  FROM dbo.tmpOnkologia2020 WHERE ReportYear=@year AND ReportMonth=@month
UNION all
...
SELECT *  INTO tmpOnkologia2020_GOOD FROM #t2 
GO
*/
DECLARE @dateStartReg DATETIME='20200101',
		@dateEndReg DATETIME='20200812',
		@year int=2020,
		@month TINYINT=8
...
FROM dbo.t_File f INNER JOIN dbo.t_RegistersAccounts a ON
            ...
            c.id=m.rf_idCase
WHERE f.DateRegistration>=@dateStartReg AND f.DateRegistration<@dateEndReg AND a.ReportYear=@year AND a.Letter='K' AND m.MUGroupCode=60 AND m.MUUnGroupCode IN(4,5,7,8,9) AND a.ReportMonth<@month
UNION ALL
SELECT p.ENP,c.DateEnd
FROM dbo.t_File f INNER JOIN dbo.t_RegistersAccounts a ON
			f.id=a.rf_idFiles
...
WHERE f.DateRegistration>=@dateStartReg AND f.DateRegistration<@dateEndReg AND a.ReportYear=@year AND a.Letter IN('Z','S','H') AND a.ReportMonth<@month
...
FROM dbo.t_File f INNER JOIN dbo.t_RegistersAccounts a ON
            ...
            p.enp=t.enp
WHERE f.DateRegistration>=@dateStartReg AND f.DateRegistration<@dateEndReg AND a.ReportYear=@year  AND c.rf_idV002 IN(18,60) AND c.DateEnd<t.DateEnd AND a.ReportMonth<@month
...
FROM dbo.t_File f INNER JOIN dbo.t_RegistersAccounts a ON
            ...
            c.id=dd.rf_idCase
             ...
             dd.DS1=d.DiagnosisCode	
WHERE f.DateRegistration>=@dateStartReg AND f.DateRegistration<@dateEndReg AND a.ReportYear=@year AND a.Letter='K' AND m.MUGroupCode=60 AND m.MUUnGroupCode IN(2,4,5,7,8,9)  AND a.ReportMonth<@month
...
FROM dbo.t_File f INNER JOIN dbo.t_RegistersAccounts a ON
            ...
            c.id=dd.rf_idCase
             ...
             c.id=m.rf_idCase
WHERE f.DateRegistration>=@dateStartReg AND f.DateRegistration<@dateEndReg AND a.ReportYear=@year AND c.rf_idV008 IN(12,13) AND a.Letter='Z' AND m.MES IN('ds19.029','ds19.033') AND a.ReportMonth<@month
...
FROM dbo.t_File f INNER JOIN dbo.t_RegistersAccounts a ON
            ...
            c.id=dd.rf_idCase
             ...
             dd.DS1=d.DiagnosisCode	
					INNER JOIN t_MES m ON
             c.id=m.rf_idCase
WHERE f.DateRegistration>=@dateStartReg AND f.DateRegistration<@dateEndReg AND a.ReportYear=@year AND c.rf_idV008 =31 AND a.Letter='Z' AND m.MES IN('ds19.029','ds19.033') AND a.ReportMonth<@month
...
FROM dbo.t_File f INNER JOIN dbo.t_RegistersAccounts a ON
            ...
            c.id=dd.rf_idCase
             ...
             dd.DS1=d.DiagnosisCode	
					INNER JOIN t_MES m ON
             c.id=m.rf_idCase
WHERE f.DateRegistration>=@dateStartReg AND f.DateRegistration<@dateEndReg AND a.ReportYear=@year AND c.rf_idV008=31 AND a.Letter='S' AND m.MES='st27.014' AND c.rf_idV006=1 AND a.ReportMonth<@month
...
FROM dbo.t_File f INNER JOIN dbo.t_RegistersAccounts a ON
            ...
            c.id=dd.rf_idCase
             ...
             c.id=pp.rf_idCase
WHERE f.DateRegistration>=@dateStartReg AND f.DateRegistration<@dateEndReg AND a.ReportYear=@year AND pp.rf_idV025='1.3' AND c.rf_idV002 IN(18,60) AND a.ReportMonth<@month
...
FROM dbo.t_File f INNER JOIN dbo.t_RegistersAccounts a ON
            ...
            c.id=dd.rf_idCase
             ...
             dd.DS1=d.DiagnosisCode	
					INNER JOIN t_MES m ON
             c.id=m.rf_idCase
WHERE f.DateRegistration>=@dateStartReg AND f.DateRegistration<@dateEndReg AND a.ReportYear=@year AND c.rf_idV008 IN(12,13) AND a.Letter='Z' AND m.MES not IN('ds19.029','ds19.033') AND c.rf_idV006=2 AND a.ReportMonth<@month
...
FROM dbo.t_File f INNER JOIN dbo.t_RegistersAccounts a ON
            ...
            c.id=dd.rf_idCase
             ...
             dd.DS1=d.DiagnosisCode	
					INNER JOIN t_MES m ON
             c.id=m.rf_idCase
WHERE f.DateRegistration>=@dateStartReg AND f.DateRegistration<@dateEndReg AND a.ReportYear=@year AND c.rf_idV008 =31 AND a.Letter='Z' AND m.MES not IN('ds19.029','ds19.033') AND c.rf_idV006=2 AND a.ReportMonth<@month
AND NOT EXISTS(SELECT 1 FROM dbo.t_ONK_SL o WHERE o.rf_idCase=c.id AND o.DS1_T=6 )
...
FROM dbo.t_File f INNER JOIN dbo.t_RegistersAccounts a ON
            ...
            c.id=dd.rf_idCase
					INNER JOIN #tDiag2 d ON
             dd.DS1=d.DiagnosisCode					
WHERE f.DateRegistration>=@dateStartReg AND f.DateRegistration<@dateEndReg AND a.ReportYear=@year AND c.rf_idV002 IN(18,60) AND a.Letter='H' AND c.rf_idV006=1 AND a.ReportMonth<@month
