...
PRINT('Итого')
GO
SELECT *  INTO tmpOnkologia2018_GOOD FROM #t2 
*/
--------------------------------------------------------------------------------------------------------
SELECT * INTO #t2 FROM tmpOnkologia2018_GOOD
...
FROM dbo.t_File f INNER JOIN dbo.t_RegistersAccounts a ON
            ...
            c.id=dd.rf_idCase
             ...
             dd.DS1=d.DiagnosisCode	
WHERE f.DateRegistration>='20180101' AND f.DateRegistration<@dateEndReg AND a.ReportYear=2018 AND a.Letter='K' AND m.MUGroupCode=60 AND m.MUUnGroupCode IN(2,4,5,7,8,9) 
...
FROM dbo.t_File f INNER JOIN dbo.t_RegistersAccounts a ON
            ...
            c.id=dd.rf_idCase
             ...
             c.id=pp.rf_idCase
WHERE f.DateRegistration>='20180101' AND f.DateRegistration<@dateEndReg AND a.ReportYear=2018 AND pp.rf_idV025='1.3' AND c.rf_idV002 IN(18,60)
...
FROM dbo.t_File f INNER JOIN dbo.t_RegistersAccounts a ON
            ...
            c.id=dd.rf_idCase
             ...
             dd.DS1=d.DiagnosisCode	
					INNER JOIN t_MES m ON
             c.id=m.rf_idCase
WHERE f.DateRegistration>=@dateStartReg AND f.DateRegistration<@dateEndReg AND a.ReportYear=2018 AND c.rf_idV008 IN(12,13) AND a.Letter='Z' 
...
FROM dbo.t_File f INNER JOIN dbo.t_RegistersAccounts a ON
            ...
            c.id=dd.rf_idCase
             ...
             dd.DS1=d.DiagnosisCode	
					INNER JOIN t_MES m ON
             c.id=m.rf_idCase
WHERE f.DateRegistration>=@dateStartReg AND f.DateRegistration<@dateEndReg AND a.ReportYear=2018 AND c.rf_idV008 =31 AND a.Letter='Z' 
...
FROM dbo.t_File f INNER JOIN dbo.t_RegistersAccounts a ON
            ...
            c.id=dd.rf_idCase
             ...
             dd.DS1=d.DiagnosisCode	
					INNER JOIN t_MES m ON
             c.id=m.rf_idCase
WHERE f.DateRegistration>=@dateStartReg AND f.DateRegistration<@dateEndReg AND a.ReportYear=2018 AND c.rf_idV008 =31 AND a.Letter='S' AND c.rf_idV006=1 
...
FROM dbo.t_File f INNER JOIN dbo.t_RegistersAccounts a ON
            ...
            c.id=dd.rf_idCase
					INNER JOIN #tDiag2 d ON
             dd.DS1=d.DiagnosisCode					
WHERE f.DateRegistration>='20180101' AND f.DateRegistration<@dateEndReg AND a.ReportYear=2018  AND a.Letter='H' AND c.rf_idV006=1
