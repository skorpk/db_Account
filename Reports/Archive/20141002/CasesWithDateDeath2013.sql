...
INSERT #tPeople( rf_idCase , PeopleID, GUID_Case,FIO ,BirthDay ,AttachLPU ,codeSMO ,Account ,NumberCase ,DateAccount ,V009 ,DateBegin 
				,DateEnd ,AmountPayment ,CodeM, DS )
...
FROM dbo.t_File f INNER JOIN dbo.t_RegistersAccounts a ON
		...
		pid.PID=pr.ID					
WHERE f.DateRegistration>'20130101' AND f.DateRegistration<'20141001' AND a.rf_idSMO<>'34' AND pr.DS<c.DateEnd		
...
FROM #tPeople c1 INNER JOIN (
							...
							WHERE DateRegistration>='20130101' AND DateRegistration<='20141001'  --AND Letter LIKE '%O'        
							GROUP BY rf_idCase
							) p ON
