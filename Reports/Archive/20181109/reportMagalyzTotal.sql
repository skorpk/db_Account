USE AccountOMS
GO
declare @dateStartReg DATETIME='20180701',
		@dateEndReg DATETIME='20181010 23:59:59',
		@reportYear SMALLINT=2018,
		@reportMonthStart TINYINT=7,
		@reportMonthEnd TINYINT=9,
		@codeSMO VARCHAR(5)='34',
		@reportMonthPolicy TINYINT=9,
		@dateStart DATE,
		@dateEnd DATE
...
WHERE p.PID IS NOT NULL and c.DateEnd>=@dateStart AND c.DateEnd<@dateEnd AND p.[Month]=@reportMonthPolicy AND p.[YEAR]=@reportYear 
---------------------------------------------------------------------------------------------------------------------------------------
