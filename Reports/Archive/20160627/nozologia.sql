...
DECLARE @dtStart DATETIME='20160101',
		@dtEnd DATETIME='20161002 23:59:59',
		@reportMM TINYINT=9
...
WHERE f.DateRegistration>@dtStart AND f.DateRegistration<@dtEnd AND a.ReportMonth>0 AND a.ReportMonth<=@reportMM AND a.ReportYear=2016 AND rf_idV006=1
