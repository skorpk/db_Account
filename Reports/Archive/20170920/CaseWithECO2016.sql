...
FROM dbo.t_File f INNER JOIN dbo.t_RegistersAccounts a ON
			...
			ce.ENP=e.ENP					                  
WHERE f.DateRegistration>=@dtBegin AND f.DateRegistration<@dtEndAmb AND c.rf_idV002=136 AND c.rf_idV006=3 AND c.DateBegin>=e.DateEnd AND a.ReportYearMonth<=201708
