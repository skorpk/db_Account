...
DECLARE @dtBegin DATETIME='20160101',	
		@dtEndReg DATETIME='20170119',
		@dtEnd DATETIME='20161231',
...
FROM dbo.t_File f INNER JOIN dbo.t_RegistersAccounts a ON
			...
			c.id=m.rf_idCase  										
					left JOIN dbo.t_Case_PID_ENP ce ON
			c.id=ce.rf_idCase 
...
--SELECT * FROM #tmpEKO WHERE ENP IS NULL
--SELECT * FROM #tmpCases WHERE ENP IS NULL	
