...
SELECT DISTINCT p1.CodeM, l.NAMES ,p1.rf_idCase ,p1.rf_idSMO ,p1.PID ,p1.DateBegin ,p1.DateEnd ,p1.rf_idV006 ,p1.DS1 ,p1.Policy,CAST(p1.AmountPayment AS MONEY) AS [Сумма принятая] 
		...
		p2.CodeM , l1.NAMES,p2.rf_idCase ,p2.rf_idSMO ,p2.PID ,p2.DateBegin ,p2.DateEnd ,p2.rf_idV006 ,p2.DS1 ,p2.Policy,CAST(p2.AmountPayment AS MONEY)  AS [Сумма принятая],CAST(p2.AmountPayment2 AS MONEY) AS [Сумма выставлен.],p2.Account,p2.DateAccount,p2.NumberCase
FROM #tPeople p1 INNER JOIN #tPeople p2 ON
		p1.rf_idV006=3  AND p2.rf_idV006=1
