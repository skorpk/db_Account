...
FROM dbo.T_ZAPROS_18_04_2018 z INNER JOIN dbo.Table_LN l ON
			...
			z.id=p.rf_idCase                          
WHERE z.kol>l.SROK1 AND p.TypeCheckup=3
...
FROM dbo.T_ZAPROS_18_04_2018 z INNER JOIN dbo.Table_LN l ON
			...
			AND z.DS=l.DS_OSN
							INNER JOIN dbo.t_PaymentAcceptedCase2 p ON
			z.id=p.rf_idCase                          
WHERE z.kol>l.SROK1 AND p.TypeCheckup=2
GROUP BY z.rf_idV002
UNION ALL
...
FROM dbo.T_ZAPROS_18_04_2018 z INNER JOIN dbo.t_PaymentAcceptedCase2 p ON
			...
			z.rf_idV002=l.PROFIL
			AND z.DS=l.DS_OSN                         
WHERE p.AmountDeduction>0  and z.kol>l.SROK1
GROUP BY z.rf_idV002
UNION ALL
...
FROM dbo.T_ZAPROS_18_04_2018 z INNER JOIN dbo.t_PaymentAcceptedCase2 p ON
			...
			z.rf_idV002=l.PROFIL
			AND z.DS=l.DS_OSN                         
WHERE p.AmountDeduction>0 AND r.CodeReason LIKE '3.%' and z.kol>l.SROK1
GROUP BY z.rf_idV002
UNION ALL
...
FROM dbo.T_ZAPROS_18_04_2018 z INNER JOIN dbo.t_PaymentAcceptedCase2 p ON
			...
			z.rf_idV002=l.PROFIL
			AND z.DS=l.DS_OSN     
WHERE p.AmountDeduction>0 AND r.CodeReason LIKE '3.2.3.' and z.kol>l.SROK1
GROUP BY z.rf_idV002
UNION ALL
...
FROM dbo.T_ZAPROS_18_04_2018 z INNER JOIN dbo.t_PaymentAcceptedCase2 p ON
			...
			z.rf_idV002=l.PROFIL
			AND z.DS=l.DS_OSN    
WHERE p.AmountDeduction>0 AND r.CodeReason LIKE '3.6.' and z.kol>l.SROK1
GROUP BY z.rf_idV002
)
