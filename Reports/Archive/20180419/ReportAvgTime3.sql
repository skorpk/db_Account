...
UNION ALL
SELECT z.rf_idV002, 0 AS Col2,COUNT(DISTINCT z.id) AS Col3,'' AS Col4,0 AS Col5,0 AS Col6,0 AS Col7,0 AS Col8,0 AS Col9,0 AS Col10
FROM dbo.T_ZAPROS_18_04_2018 z INNER JOIN dbo.Table_LN l ON
			z.rf_idV002=l.PROFIL
			AND z.DS=l.DS_OSN
WHERE l.IsNeed=1 and  z.kol>l.SROK1
GROUP BY z.rf_idV002,l.DS_OSN
UNION all
SELECT z.rf_idV002,0,0 AS Col3,'' AS Col4,COUNT(DISTINCT z.id) AS Col5,0 AS Col6,0 AS Col7,0 AS Col8,0 AS Col9,0 AS Col10
FROM dbo.T_ZAPROS_18_04_2018 z INNER JOIN dbo.Table_LN l ON
			z.rf_idV002=l.PROFIL
			AND z.DS=l.DS_OSN
							INNER JOIN dbo.t_PaymentAcceptedCase2 p ON
			z.id=p.rf_idCase                          
WHERE l.IsNeed=1 and  z.kol>l.SROK1 AND p.TypeCheckup=3
GROUP BY z.rf_idV002
UNION ALL
SELECT z.rf_idV002,0,0 AS Col3,'' AS Col4,0 AS Col5,0 AS Col6,0 AS Col7,0 AS Col8,0 AS Col9,COUNT(DISTINCT z.id) AS Col10
FROM dbo.T_ZAPROS_18_04_2018 z INNER JOIN dbo.Table_LN l ON
			z.rf_idV002=l.PROFIL
			AND z.DS=l.DS_OSN
							INNER JOIN dbo.t_PaymentAcceptedCase2 p ON
			z.id=p.rf_idCase                          
WHERE l.IsNeed=1 and z.kol>l.SROK1 AND p.TypeCheckup=2
GROUP BY z.rf_idV002
UNION ALL
...
FROM dbo.T_ZAPROS_18_04_2018 z INNER JOIN dbo.t_PaymentAcceptedCase2 p ON
			z.id=p.rf_idCase 
							INNER JOIN dbo.Table_LN l ON
			z.rf_idV002=l.PROFIL
			AND z.DS=l.DS_OSN                         
WHERE l.IsNeed=1 and  p.AmountDeduction>0  and z.kol>l.SROK1
GROUP BY z.rf_idV002
UNION ALL
...
FROM dbo.T_ZAPROS_18_04_2018 z INNER JOIN dbo.t_PaymentAcceptedCase2 p ON
			...
			z.rf_idV002=l.PROFIL
			AND z.DS=l.DS_OSN                         
WHERE l.IsNeed=1 and  p.AmountDeduction>0 AND r.CodeReason LIKE '3.%' and z.kol>l.SROK1
GROUP BY z.rf_idV002
UNION ALL
...
FROM dbo.T_ZAPROS_18_04_2018 z INNER JOIN dbo.t_PaymentAcceptedCase2 p ON
			...
			z.rf_idV002=l.PROFIL
			AND z.DS=l.DS_OSN     
WHERE l.IsNeed=1 and  p.AmountDeduction>0 AND r.CodeReason LIKE '3.2.3.' and z.kol>l.SROK1
GROUP BY z.rf_idV002
UNION ALL
...
FROM dbo.T_ZAPROS_18_04_2018 z INNER JOIN dbo.t_PaymentAcceptedCase2 p ON
			...
			z.rf_idV002=l.PROFIL
			AND z.DS=l.DS_OSN    
WHERE l.IsNeed=1 and  p.AmountDeduction>0 AND r.CodeReason LIKE '3.6.' and z.kol>l.SROK1
GROUP BY z.rf_idV002
)
SELECT TOP 100 PERCENT v2.id,v2.name AS PROFIL ,
        ...
        SUM(c.Col3) AS Col3 ,		
        --t.Col4 ,
        sum(Col5) as Col5_EKMP,
		SUM(Col10) AS Co5_MEE,
        sum(Col6) as Col6,
        sum(Col7) as Col7,
        sum(Col8) as Col8,
        sum(Col9) as Col9,
...
FROM cteDiag c INNER JOIN RegisterCases.dbo.vw_sprV002 v2 ON
		   c.PROFIL=v2.id
			...
			--							AND z.DS=l.DS_OSN
			--				WHERE l.IsNeed=1 and z.kol>l.SROK1
			--				GROUP BY z.rf_idV002,l.DS_OSN) t ON
			--c.PROFIL=t.rf_idV002                          
GROUP BY v2.id,v2.name--,t.Col4
ORDER BY v2.id