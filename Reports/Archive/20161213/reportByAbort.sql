...
WHERE f.DateRegistration>=@dtBegin AND f.DateRegistration<@dtEnd AND a.ReportYear=@reportYear /*AND a.ReportMonth<=@reportMonth */AND c.rf_idV006 IN (1,2,3) 
