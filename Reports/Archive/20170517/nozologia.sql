...
DECLARE @dtStart DATETIME='20160101',  --дата начало регистрации
		@dtEnd DATETIME='20170119 23:59:59',--дата окончания регистрации
		@dtEndRAK DATETIME='20170119 23:59:59',--дата окончания регистрации РАК
		@reportMM TINYINT=12,--указываете последний месяц из отчетного периода
		@reportYear SMALLINT=2016  --отчетный год
