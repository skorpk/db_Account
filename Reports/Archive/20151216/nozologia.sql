...
DECLARE @dtStart DATETIME='20150101',
		@dtEnd DATETIME='20151215 23:59:59'
...
FROM dbo.t_File f INNER JOIN dbo.t_RegistersAccounts a ON
			f.id=a.rf_idFiles
				  INNER JOIN (VALUES('34001'),('34002'),('34006')) v(CodeSMO) ON
...
WHERE f.DateRegistration>@dtStart AND f.DateRegistration<@dtEnd AND a.ReportMonth>0 AND a.ReportMonth<=11 AND a.ReportYear=2015 AND rf_idV006=1
