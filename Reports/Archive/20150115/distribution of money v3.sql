...
SELECT l.filialName,t.CodeM,l.Names,l.pfa		
				...
				,CAST(SUM(CASE WHEN t.CodeM=t.AttachLPU then Col14-Col9-Col10-Col11-Col12-Col13 ELSE 0 END) AS MONEY) AS Col14_1
				,CAST(SUM(CASE WHEN t.CodeM<>t.AttachLPU then Col14-Col9-Col10-Col11-Col12-Col13 ELSE 0 END) AS MONEY) AS Col14_2
