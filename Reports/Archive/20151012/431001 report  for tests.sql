USE AccountOMS
GO
DECLARE @codeM CHAR(6)='431001',
		@reportYear SMALLINT=2014,
		@dateStart DATETIME='20141001',
		@dateEnd DATETIME='20151006 23:59:59',
...
WHERE f.DateRegistration>@dateStart AND f.DateRegistration<@dateEnd AND a.ReportMonth>9 AND a.ReportMonth<=12 AND a.ReportYear=@reportYear 
