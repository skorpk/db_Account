...
declare @dateStartReg DATETIME='20180101',
		@dateEndReg DATETIME='20180410 23:59:59',
...
FROM PeopleAttach.[dbo].[CancerRegistr-1] p INNER JOIN dbo.t_PatientSMO ps ON
		p.ENP=ps.ENP
								INNER JOIN dbo.t_RecordCasePatient r ON
		ps.rf_idRecordCasePatient = r.id
								INNER JOIN dbo.t_Case c ON
		r.id = c.rf_idRecordCasePatient                              
WHERE p.PID IS NOT NULL and c.DateEnd>='20180101' AND c.DateEnd<'20180401'--c.ReportYear=@reportYear AND p.[YEAR]=@reportYear 
