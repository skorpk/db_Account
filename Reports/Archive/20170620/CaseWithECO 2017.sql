...
DECLARE @dtBegin DATETIME='20170101',	
		@dtEndReg DATE='20170630',
		@dtEnd DATETIME='20170712 23:59:59',
		@dtEndAmb DATETIME='20170821',
...
--определяем людей из БД Калиничева
INSERT #tmpEKO (rf_idCase,AmountPayment,DateEnd,PID,ENP) 
...
FROM dbo.t_File f INNER JOIN dbo.t_RegistersAccounts a ON
			...
			ce.ENP=e.ENP
WHERE f.DateRegistration>=@dtBegin AND f.DateRegistration<@dtEndAmb AND c.rf_idV002=136 AND c.rf_idV006=3 AND c.DateBegin>=e.DateEnd AND a.ReportYearMonth<=201707 AND e.AmountPayment>0
