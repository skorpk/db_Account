USE AccountOMS
GO
DECLARE @codeM CHAR(6)='551001',
		@reportYear SMALLINT=2015,
		@dateStart DATETIME='20150101',
		@dateEnd DATETIME='20150807 23:59:59',
		@dateEndPay DATETIME='20150807'
...
FROM dbo.t_File f INNER JOIN dbo.t_RegistersAccounts a ON
			...
			AND f.CodeM=@codeM
			AND a.rf_idSMO<>'34'
					INNER JOIN (VALUES('O'),('R'),('F') ,('I')/*,('D')*/,('V'),('U') ) v(letter) ON
			a.Letter=v.letter
...
SELECT p1.FAM+' '+p1.IM+' '+ISNULL(p1.OT,'') AS FIO,CAST(p1.DR AS DATE) AS DR,p.Policy,s.sNameS,p.NumberHistoryCase,d.DS1,p.Account,p.DateAccount,p.NumberCase,
		p.DateBegin,p.DateEnd,CAST(ISNULL(p.AmountPayment,0) AS MONEY),ISNULL(IsSpecialCase,0)
