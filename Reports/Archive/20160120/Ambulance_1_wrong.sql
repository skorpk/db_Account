...
INSERT #tPeople( rf_idCase ,CodeM ,CodeSMO ,AmountPayment,DateBeg, DateEnd,PID,Sex,Age,rf_idV006,rf_idV008,rf_idV009,NumberCase)
SELECT c.id,f.CodeM,a.rf_idSMO,c.AmountPayment,c.DateBegin,c.DateEnd,p.PID,peo.W,c.Age
		,c.rf_idV006,c.rf_idV008,c.rf_idV009,c.idRecordCase
...
SELECT p.rf_idCase ,p.DateBeg ,p.PID ,p.SNILS_Doc ,p.AttachLPU ,p.Sex ,p.Age ,p.NumberCase ,p.rf_idV006 ,p.rf_idV008 ,p.rf_idV009
FROM #tPeople p	
