...
DECLARE @startDateReg DATETIME='20180110',
		@endDateReg DATETIME='20180407',
		@endDateRegAkt DATETIME='20180425',
...
WHERE f.DateRegistration>@startDateReg AND f.DateRegistration<=@endDateReg AND a.ReportMonth<=@reportMonth AND a.ReportYear=@reportYear 
		AND c.DateEnd>='20180101' AND c.DateEnd<='20180401' AND a.Letter='O' AND d.TypeDisp IN ('ÄÂ1','ÄÂ2','ÄÂ3')
...
SELECT 1,0 AS Col3,0 AS Col4
	 ,COUNT(DISTINCT p.ENP) AS Col5
	 ,COUNT(DISTINCT p.ENP)  AS Col6
	 ,0 AS Col7
	 ,SUM(AmountPaymentAccepted) AS Col8
	 ,count( DISTINCT CASE WHEN TypeDisp IN('ÄÂ1','ÄÂ3') AND AmountPaymentAccepted>0 THEN p.ENP ELSE NULL END) AS Col9
	 ,0 AS Col10
	 ,sum(CASE WHEN TypeDisp='ÄÂ1' THEN AmountPaymentAccepted ELSE 0.0 END) AS Col11
	 ,count( DISTINCT CASE WHEN TYpeDisp='ÄÂ2' and AmountPaymentAccepted>0 THEN p.ENP ELSE NULL END) AS Col12
	 ,count( DISTINCT CASE WHEN TYpeDisp='ÄÂ2' and AmountPaymentAccepted>0 THEN p.ENP ELSE NULL END) AS Col13
	 ,sum(CASE WHEN TypeDisp='ÄÂ2' THEN AmountPaymentAccepted ELSE 0.0 END) AS Col14
	 ,count(DISTINCT CASE WHEN TypeDisp IN('ÄÂ1','ÄÂ3') AND IsMobileTeam=1 and AmountPaymentAccepted>0 THEN p.ENP ELSE NULL END) AS Col15
	 ,sum(DISTINCT CASE WHEN TypeDisp IN('ÄÂ1','ÄÂ3') AND IsMobileTeam=1 THEN AmountPaymentAccepted ELSE 0.0 END) AS Col16
	 ,sum(CASE WHEN AmountPaymentAccepted>0 THEN AmountPay ELSE 0.0 END) AS Col17
	 ,count(DISTINCT CASE WHEN AmountPaymentAccepted>0 AND TypeDisp IN('ÄÂ1','ÄÂ3') AND AmountPay>0 THEN p.ENP ELSE null END) AS Col18
	 ,0 AS Col19,0 AS Col20
	 ,sum(CASE WHEN TypeDisp IN('ÄÂ1','ÄÂ3') and AmountPaymentAccepted>0 THEN AmountPay ELSE 0.0 END) AS Col21
	 ,count(DISTINCT CASE WHEN AmountPaymentAccepted>0 AND AmountPay>0 AND TypeDisp='ÄÂ2' THEN p.ENP ELSE null END) AS Col22
	 ,count(DISTINCT CASE WHEN AmountPaymentAccepted>0 AND AmountPay>0 AND TypeDisp='ÄÂ2' THEN p.ENP ELSE null END) AS Col23
	 ,0 AS Col24
	 ,sum(CASE WHEN TypeDisp ='ÄÂ2' and AmountPaymentAccepted>0 THEN AmountPay ELSE 0.0 END) AS Col25
	 ,count(DISTINCT CASE WHEN TypeDisp IN('ÄÂ1','ÄÂ3') AND IsMobileTeam=1 and AmountPaymentAccepted>0 AND AmountPay>0 THEN p.ENP ELSE null END) AS Col26
	 ,sum(CASE WHEN TypeDisp IN('ÄÂ1','ÄÂ3') AND IsMobileTeam=1 and AmountPaymentAccepted>0 THEN AmountPay ELSE 0.0 END) AS Col27
	 ----------------------------------------------------------------------------------------------------------------------	  
	 ,COUNT( DISTINCT CASE WHEN (AmountPaymentAccepted>0 AND AmountPay>0 AND TypeDisp='ÄÂ2') OR (AmountPaymentAccepted>0 AND AmountPay>0 AND TypeDisp IN('ÄÂ1','ÄÂ3') AND IsLastCase=1) THEN p.ENP ELSE NULL END) AS col28
	 ,COUNT( DISTINCT CASE WHEN (AmountPaymentAccepted>0 AND AmountPay>0 AND TypeDisp='ÄÂ2' AND TypeFailure=1) OR (AmountPaymentAccepted>0 AND AmountPay>0 AND TypeDisp IN('ÄÂ1','ÄÂ3') AND IsLastCase=1 AND TypeFailure=1) THEN p.ENP ELSE NULL END) AS col29
	 ,COUNT( DISTINCT CASE WHEN (AmountPaymentAccepted>0 AND AmountPay>0 AND TypeDisp='ÄÂ2' AND RSLT=317) OR (AmountPaymentAccepted>0 AND AmountPay>0 AND TypeDisp IN('ÄÂ1','ÄÂ3') /*AND IsLastCase=1*/ AND RSLT=352) OR (AmountPaymentAccepted>0 AND AmountPay>0 AND TypeDisp IN('ÄÂ1','ÄÂ3') AND RSLT=317) THEN p.ENP ELSE NULL END) AS col30
	 ,COUNT( DISTINCT CASE WHEN (AmountPaymentAccepted>0 AND AmountPay>0 AND TypeDisp='ÄÂ2' AND RSLT=318) OR (AmountPaymentAccepted>0 AND AmountPay>0 AND TypeDisp IN('ÄÂ1','ÄÂ3') /*AND IsLastCase=1*/ AND RSLT=353) OR (AmountPaymentAccepted>0 AND AmountPay>0 AND TypeDisp IN('ÄÂ1','ÄÂ3') AND RSLT=318) THEN p.ENP ELSE NULL END) AS col31
	 ,COUNT( DISTINCT CASE WHEN (AmountPaymentAccepted>0 AND AmountPay>0 AND TypeDisp='ÄÂ2' AND RSLT=355) OR (AmountPaymentAccepted>0 AND AmountPay>0 AND TypeDisp IN('ÄÂ1','ÄÂ3') /*AND IsLastCase=1*/ AND RSLT=357) OR (AmountPaymentAccepted>0 AND AmountPay>0 AND TypeDisp IN('ÄÂ1','ÄÂ3') AND RSLT=355) THEN p.ENP ELSE NULL END) AS col32
	 ,COUNT( DISTINCT CASE WHEN (AmountPaymentAccepted>0 AND AmountPay>0 AND TypeDisp='ÄÂ2' AND RSLT=356) OR (AmountPaymentAccepted>0 AND AmountPay>0 AND TypeDisp IN('ÄÂ1','ÄÂ3') /*AND IsLastCase=1*/ AND RSLT=358) OR (AmountPaymentAccepted>0 AND AmountPay>0 AND TypeDisp IN('ÄÂ1','ÄÂ3') AND RSLT=356) THEN p.ENP ELSE NULL END) AS col33
	 -----------------------------------------------------------------------------------------------------------------------
...
FROM #tPeople p LEFT JOIN dbo.t_R02ENP e on
		p.ENP=e.ENP
				LEFT JOIN #prescription pp ON
		p.rf_idCase=pp.rf_idCase
WHERE rf_idV005=1
UNION ALL
SELECT 2,0 AS Col3,0 AS Col4
	 ,COUNT(DISTINCT p.ENP) AS Col5
	 ,COUNT(DISTINCT p.ENP)  AS Col6
	 ,0 AS Col7
	 ,SUM(AmountPaymentAccepted) AS Col8
...
UNION ALL
SELECT 4,0 AS Col3,0 AS Col4,COUNT(DISTINCT p.ENP) AS Col5
	 ,COUNT(DISTINCT p.ENP)  AS Col6,0 AS Col7
	 ,SUM(AmountPaymentAccepted) AS Col8
	 ,count( DISTINCT CASE WHEN TypeDisp IN('ÄÂ1','ÄÂ3') AND AmountPaymentAccepted>0 THEN p.ENP ELSE NULL END) AS Col9
	 ,0 AS Col10
	 ,sum(CASE WHEN TypeDisp='ÄÂ1' THEN AmountPaymentAccepted ELSE 0.0 END) AS Col11
...
UNION ALL
SELECT 6,0 AS Col3,0 AS Col4,COUNT(DISTINCT p.ENP) AS Col5,COUNT(DISTINCT p.ENP) AS Col6,0 AS Col7
	 ,SUM(AmountPaymentAccepted) AS Col8
	 ,count( DISTINCT CASE WHEN TypeDisp IN('ÄÂ1','ÄÂ3') AND AmountPaymentAccepted>0 THEN p.ENP ELSE NULL END) AS Col9
	 ,0 AS Col10
	 ,sum(CASE WHEN TypeDisp='ÄÂ1' THEN AmountPaymentAccepted ELSE 0.0 END) AS Col11
...
UNION ALL
SELECT 7,0 AS Col3,0 AS Col4,COUNT(DISTINCT p.ENP) AS Col5,COUNT(DISTINCT p.ENP) AS Col6,0 AS Col7
	 ,SUM(AmountPaymentAccepted) AS Col8
	 ,count( DISTINCT CASE WHEN TypeDisp IN('ÄÂ1','ÄÂ3') AND AmountPaymentAccepted>0 THEN p.ENP ELSE NULL END) AS Col9
	 ,0 AS Col10
	 ,sum(CASE WHEN TypeDisp='ÄÂ1' THEN AmountPaymentAccepted ELSE 0.0 END) AS Col11
...
UNION ALL
SELECT 8,0 AS Col3,0 AS Col4,COUNT(DISTINCT p.ENP) AS Col5,COUNT(DISTINCT p.ENP) AS Col6,0 AS Col7
	 ,SUM(AmountPaymentAccepted) AS Col8
	 ,count( DISTINCT CASE WHEN TypeDisp IN('ÄÂ1','ÄÂ3') AND AmountPaymentAccepted>0 THEN p.ENP ELSE NULL END) AS Col9
	 ,0 AS Col10
	 ,sum(CASE WHEN TypeDisp='ÄÂ1' THEN AmountPaymentAccepted ELSE 0.0 END) AS Col11
...
FROM #tPeople p LEFT JOIN dbo.t_R02ENP e on
		p.ENP=e.ENP
			LEFT JOIN #prescription pp ON
		p.rf_idCase=pp.rf_idCase
WHERE rf_idV005=1 AND TypeDisp ='ÄÂ3' 
UNION ALL
----------------------------------------------------------Women-------------------------------------------
SELECT 9,0 AS Col3,0 AS Col4,COUNT(DISTINCT p.ENP) AS Col5,COUNT(DISTINCT p.ENP) AS Col6,0 AS Col7
	 ,SUM(AmountPaymentAccepted) AS Col8
	 ,count( DISTINCT CASE WHEN TypeDisp IN('ÄÂ1','ÄÂ3') AND AmountPaymentAccepted>0 THEN p.ENP ELSE NULL END) AS Col9
	 ,0 AS Col10
	 ,sum(CASE WHEN TypeDisp='ÄÂ1' THEN AmountPaymentAccepted ELSE 0.0 END) AS Col11
...
WHERE rf_idV005=2
UNION ALL
SELECT 10,0 AS Col3,0 AS Col4,COUNT(DISTINCT p.ENP) AS Col5,COUNT(DISTINCT p.ENP) AS Col6,0 AS Col7
	 ,SUM(AmountPaymentAccepted) AS Col8
	 ,count( DISTINCT CASE WHEN TypeDisp IN('ÄÂ1','ÄÂ3') AND AmountPaymentAccepted>0 THEN p.ENP ELSE NULL END) AS Col9
	 ,0 AS Col10
	 ,sum(CASE WHEN TypeDisp='ÄÂ1' THEN AmountPaymentAccepted ELSE 0.0 END) AS Col11
...
UNION ALL
SELECT 11,0 AS Col3,0 AS Col4,COUNT(DISTINCT p.ENP) AS Col5,COUNT(DISTINCT p.ENP) AS Col6,0 AS Col7
	 ,SUM(AmountPaymentAccepted) AS Col8
	 ,count( DISTINCT CASE WHEN TypeDisp IN('ÄÂ1','ÄÂ3') AND AmountPaymentAccepted>0 THEN p.ENP ELSE NULL END) AS Col9
	 ,0 AS Col10
	 ,sum(CASE WHEN TypeDisp='ÄÂ1' THEN AmountPaymentAccepted ELSE 0.0 END) AS Col11
...
UNION ALL
SELECT 12,0 AS Col3,0 AS Col4,COUNT(DISTINCT p.ENP) AS Col5,COUNT(DISTINCT p.ENP) AS Col6,0 AS Col7
	 ,SUM(AmountPaymentAccepted) AS Col8
	 ,count( DISTINCT CASE WHEN TypeDisp IN('ÄÂ1','ÄÂ3') AND AmountPaymentAccepted>0 THEN p.ENP ELSE NULL END) AS Col9
	 ,0 AS Col10
	 ,sum(CASE WHEN TypeDisp='ÄÂ1' THEN AmountPaymentAccepted ELSE 0.0 END) AS Col11
...
UNION ALL
SELECT 13,0 AS Col3,0 AS Col4,COUNT(DISTINCT p.ENP) AS Col5,COUNT(DISTINCT p.ENP) AS Col6,0 AS Col7
	 ,SUM(AmountPaymentAccepted) AS Col8
	 ,count( DISTINCT CASE WHEN TypeDisp IN('ÄÂ1','ÄÂ3') AND AmountPaymentAccepted>0 THEN p.ENP ELSE NULL END) AS Col9
	 ,0 AS Col10
	 ,sum(CASE WHEN TypeDisp='ÄÂ1' THEN AmountPaymentAccepted ELSE 0.0 END) AS Col11
...
UNION ALL
SELECT 14,0 AS Col3,0 AS Col4,COUNT(DISTINCT p.ENP) AS Col5,COUNT(DISTINCT p.ENP) AS Col6,0 AS Col7
	 ,SUM(AmountPaymentAccepted) AS Col8
	 ,count( DISTINCT CASE WHEN TypeDisp IN('ÄÂ1','ÄÂ3') AND AmountPaymentAccepted>0 THEN p.ENP ELSE NULL END) AS Col9
	 ,0 AS Col10
	 ,sum(CASE WHEN TypeDisp='ÄÂ1' THEN AmountPaymentAccepted ELSE 0.0 END) AS Col11
...
UNION ALL
SELECT 15,0 AS Col3,0 AS Col4,COUNT(DISTINCT p.ENP) AS Col5,COUNT(DISTINCT p.ENP) AS Col6,0 AS Col7
	 ,SUM(AmountPaymentAccepted) AS Col8
	 ,count( DISTINCT CASE WHEN TypeDisp IN('ÄÂ1','ÄÂ3') AND AmountPaymentAccepted>0 THEN p.ENP ELSE NULL END) AS Col9
	 ,0 AS Col10
	 ,sum(CASE WHEN TypeDisp='ÄÂ1' THEN AmountPaymentAccepted ELSE 0.0 END) AS Col11
...
UNION ALL
SELECT 16,0 AS Col3,0 AS Col4,COUNT(DISTINCT p.ENP) AS Col5,COUNT(DISTINCT p.ENP) AS Col6,0 AS Col7
	 ,SUM(AmountPaymentAccepted) AS Col8
	 ,count( DISTINCT CASE WHEN TypeDisp IN('ÄÂ1','ÄÂ3') AND AmountPaymentAccepted>0 THEN p.ENP ELSE NULL END) AS Col9
	 ,0 AS Col10
	 ,sum(CASE WHEN TypeDisp='ÄÂ1' THEN AmountPaymentAccepted ELSE 0.0 END) AS Col11
...
UNION ALL
SELECT 17,0 AS Col3,0 AS Col4,COUNT(DISTINCT p.ENP) AS Col5,COUNT(DISTINCT p.ENP) AS Col6,0 AS Col7
	 ,SUM(AmountPaymentAccepted) AS Col8
	 ,count( DISTINCT CASE WHEN TypeDisp IN('ÄÂ1','ÄÂ3') AND AmountPaymentAccepted>0 THEN p.ENP ELSE NULL END) AS Col9
	 ,0 AS Col10
	 ,sum(CASE WHEN TypeDisp='ÄÂ1' THEN AmountPaymentAccepted ELSE 0.0 END) AS Col11
...
UNION ALL
SELECT 18,0 AS Col3,0 AS Col4,COUNT(DISTINCT p.ENP) AS Col5,COUNT(DISTINCT p.ENP) AS Col6,0 AS Col7
	 ,SUM(AmountPaymentAccepted) AS Col8
	 ,count( DISTINCT CASE WHEN TypeDisp IN('ÄÂ1','ÄÂ3') AND AmountPaymentAccepted>0 THEN p.ENP ELSE NULL END) AS Col9
	 ,0 AS Col10
	 ,sum(CASE WHEN TypeDisp='ÄÂ1' THEN AmountPaymentAccepted ELSE 0.0 END) AS Col11
