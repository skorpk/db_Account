USE AccountOMS
GO
DECLARE @startDateReg DATETIME='20190101',
        @endDateReg DATETIME='20190410',
        @endDateRegAkt DATETIME='20190410',
        @endDateRegPay DATETIME='20190410',
        @reportYear smallint=2019,
        @reportMonth TINYINT=3,
        @codeSMO CHAR(5)='34002',
		@dtEndB DATE='20190331'

SET STATISTICS TIME, IO ON

SELECT distinct c.id AS rf_idCase,c.AmountPayment,f.CodeM,p.ENP, DATEDIFF(YEAR,rp.BirthDay,'20191231') AS Age,rp.rf_idV005, CAST(0 AS DECIMAL(11,2)) AS AmountPaymentAccepted, CAST(0 AS DECIMAL(11,2)) AS AmountPay
...
WHERE f.DateRegistration>@startDateReg AND f.DateRegistration<=@endDateReg AND a.ReportMonth<=@reportMonth AND a.ReportYear=@reportYear 
		AND c.DateEnd>='20190101' AND c.DateEnd<'20190201' AND a.Letter='O' AND d.TypeDisp IN ('ÄÂ1','ÄÂ2','ÄÂ3')
...
FROM #tPeople p INNER JOIN (
							...
							WHERE p.DateRegistration>='20190101' AND p.DateRegistration<@endDateRegAkt
