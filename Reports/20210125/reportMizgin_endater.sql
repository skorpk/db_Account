...
DECLARE @dateStart DATETIME='20210101',
		@dateEnd DATETIME='20210405',
		@dateEndPay DATETIME='20210405'
...
SELECT DISTINCT c.id AS rf_idCase, f.CodeM, c.AmountPayment,c.rf_idRecordCasePatient,c.rf_idV006,mm.MUSurgery,a.rf_idSMO
INTO #tCases
...
WHERE f.DateRegistration>@dateStart AND f.DateRegistration<@dateEnd AND a.ReportYearMonth<=202103
		AND c.rf_idV006<3 
