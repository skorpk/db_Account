...
INSERT #tLPU(CodeM) VALUES('101001'),('103001'),('114504'),('124528'),('141023'),('154602'),('174601'),('175603'),('251001'),('391002'),('451001')
...
;WITH cte
AS(
SELECT CodeM,DiagnosisCode ,COUNT(DISTINCT rf_idRecordCasePatient) AS Col3,a.rf_idAddCretiria AS Col4,CASE WHEN d.rf_idV024 IN('sh903','sh904') THEN d.MNN ELSE null END AS Col5
...
GROUP BY t.rf_idCase,CodeM,DiagnosisCode ,a.rf_idAddCretiria,CASE WHEN d.rf_idV024 IN('sh903','sh904') THEN d.MNN ELSE null END
)
SELECT c1.CodeM+' - '+l.NAMES AS LPU,RTRIM(c1.DiagnosisCode)+' - '+m10.Diagnosis AS DiagnosisCode,SUM(col3) AS Col3,ISNULL(c1.Col4,''),ISNULL(c1.col5,'')
