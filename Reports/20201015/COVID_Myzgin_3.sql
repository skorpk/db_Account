...
SELECT 1 AS ColName,SUM(CASE WHEN TypeRequest=1 THEN amountDeduction ELSE 0 END) AS Col1_Amb
...
UNION all
SELECT 2 AS ColName,SUM(CASE WHEN TypeRequest=1 THEN AmountPayment ELSE 0 END) AS Col1_Amb
		,SUM(CASE WHEN TypeRequest=2 THEN AmountPayment ELSE 0 END) AS Col2_Amb
