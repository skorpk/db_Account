...
CREATE TABLE #tSMO(CodeSMO VARCHAR(5))

INSERT #tSMO(CodeSMO) VALUES(@codeSMO )
...
FROM dbo.t_File f INNER JOIN dbo.t_RegistersAccounts a ON
            ...
            c.id=m.rf_idCase
WHERE f.DateRegistration>=@dateStartReg AND f.DateRegistration<@dateEndReg  AND a.ReportYear=@reportYear AND m.MES='2005.0' AND a.rf_idSMO=@codeSMO
...
SELECT ReportYear,t.CodeM,COUNT(DISTINCT t.rf_idCase) 
FROM #t t INNER JOIN dbo.t_Coefficient cc ON
		t.rf_idCase=cc.rf_idCase
			INNER JOIN dbo.t_Meduslugi m ON
        t.rf_idCase=m.rf_idCase
WHERE cc.Code_SL=12 AND m.MUSurgery='A11.20.025.001' AND AmountPayment>0
...
FROM #t t INNER JOIN dbo.t_Meduslugi m ON
        t.rf_idCase=m.rf_idCase
WHERE m.MUSurgery IN( 'A11.20.028','A11.20.036' ) AND NOT EXISTS(SELECT 1 FROM dbo.t_Coefficient cc WHERE cc.rf_idCase=t.rf_idCase) AND AmountPayment>0
GROUP BY ReportYear,CodeM
PRINT 'Col5'
...
FROM #t t INNER JOIN dbo.t_Meduslugi m ON
        t.rf_idCase=m.rf_idCase
WHERE m.MUSurgery IN( 'A11.20.017' ) AND  NOT EXISTS(SELECT 1 FROM dbo.t_Coefficient cc WHERE cc.rf_idCase=t.rf_idCase) AND AmountPayment>0
	AND NOT EXISTS(SELECT 1 FROM dbo.t_Meduslugi mm WHERE mm.rf_idCase=t.rf_idCase AND mm.MUSurgery IN( 'A11.20.028','A11.20.036' ) )
GROUP BY ReportYear,CodeM
PRINT 'Col6'
...
FROM #t t INNER JOIN dbo.t_Coefficient cc ON
		t.rf_idCase=cc.rf_idCase
			INNER JOIN dbo.t_Meduslugi m ON
        t.rf_idCase=m.rf_idCase
WHERE cc.Code_SL=13 AND m.MUSurgery='A11.20.031' AND AmountPayment>0
GROUP BY ReportYear,CodeM
PRINT 'Col7'
...
FROM #t t INNER JOIN dbo.t_Coefficient cc ON
		t.rf_idCase=cc.rf_idCase
			INNER JOIN dbo.t_Meduslugi m ON
        t.rf_idCase=m.rf_idCase
WHERE cc.Code_SL=14 AND m.MUSurgery='A11.20.030.001' AND AmountPayment>0
GROUP BY ReportYear,CodeM
PRINT 'Col8'
...
WHERE f.DateRegistration>=@dateStartReg AND f.DateRegistration<'20191231' AND a.ReportYear>=@reportYear AND c.rf_idV006=3-- AND c.rf_idV002=137
...
FROM dbo.t_File f INNER JOIN dbo.t_RegistersAccounts a ON
            ...
            d.DS1=dd.DiagnosisCode
WHERE f.DateRegistration>=@dateStartReg AND f.DateRegistration<'20191231'  AND a.ReportYear>=@reportYear AND c.rf_idV006=1 AND dd.MainDS BETWEEN 'O80' AND 'O84'
GROUP BY e.CodeM
PRINT 'Col12'
--------------------------Колонки 14-15-----------------------
...
FROM dbo.t_File f INNER JOIN dbo.t_RegistersAccounts a ON
            ...
            p.enp=e.ENP
					INNER JOIN dbo.t_Case c ON
			r.id=c.rf_idRecordCasePatient										
WHERE f.DateRegistration>=@dateStartReg AND f.DateRegistration<'20191231'  AND a.ReportYear>=@reportYear AND r.BirthWeight IS NOT null
GROUP BY e.CodeM
PRINT 'Col14'
...
FROM dbo.t_File f INNER JOIN dbo.t_RegistersAccounts a ON
            ...
            c.id=d.rf_idCase
					INNER JOIN #tDiag dd ON
            d.DS1=dd.DiagnosisCode
WHERE f.DateRegistration>=@dateStartReg AND f.DateRegistration<@dateEndReg  AND a.ReportYear>=@reportYear AND c.rf_idV006=3 --AND c.rf_idV002=137
...
SELECT DISTINCT ENP,e.rf_idCase,e.CodeM
INTO #tENP2
FROM dbo.t_Case c INNER JOIN #tEnp e ON
			c.id=e.rf_idCase								
WHERE c.rf_idV006=2 AND c.Age>35	
...
SELECT @codeSMO=CodeSMO FROM #tSMO
...
FROM dbo.t_File f INNER JOIN dbo.t_RegistersAccounts a ON
			...
			r.id=c.rf_idRecordCasePatient					
					INNER JOIN dbo.t_MES m ON
            c.id=m.rf_idCase
WHERE f.DateRegistration>=@dateStartReg AND f.DateRegistration<@dateEndReg  AND a.ReportYear=@reportYear AND m.MES='ds02.005' AND a.rf_idSMO=@codeSMO
...
FROM #t t INNER JOIN dbo.t_Meduslugi m ON
        t.rf_idCase=m.rf_idCase
WHERE /*m.MUSurgery IN( 'A11.20.030' ) AND  */NOT EXISTS(SELECT 1 FROM dbo.t_Coefficient cc WHERE cc.rf_idCase=t.rf_idCase) AND AmountPayment>0
	AND NOT EXISTS(SELECT 1 FROM dbo.t_Meduslugi mm WHERE mm.rf_idCase=t.rf_idCase AND mm.MUSurgery IN( 'A11.20.028','A11.20.036' ) )
GROUP BY ReportYear,CodeM
PRINT 'Col6'
...
FROM #t t INNER JOIN dbo.t_Coefficient cc ON
		t.rf_idCase=cc.rf_idCase
			INNER JOIN dbo.t_Meduslugi m ON
        t.rf_idCase=m.rf_idCase
WHERE cc.Code_SL=13 AND AmountPayment>0
GROUP BY ReportYear,CodeM
PRINT 'Col7'
...
FROM #t t INNER JOIN dbo.t_Coefficient cc ON
		t.rf_idCase=cc.rf_idCase
			INNER JOIN dbo.t_Meduslugi m ON
        t.rf_idCase=m.rf_idCase
WHERE cc.Code_SL=15 AND (m.MUSurgery='A11.20.025.001' OR(m.MUSurgery='A11.20.025.001' AND m.MUSurgery='A11.20.17')) AND AmountPayment>0
AND NOT EXISTS(SELECT 1 FROM dbo.t_Meduslugi mm WHERE mm.rf_idCase=t.rf_idCase AND m.MUSurgery IS NOT null)
GROUP BY ReportYear,CodeM
PRINT 'Col4'
...
FROM #t t INNER JOIN dbo.t_Meduslugi m ON
        t.rf_idCase=m.rf_idCase
WHERE /*m.MUSurgery ='A11.20.030' AND*/  NOT EXISTS(SELECT 1 FROM dbo.t_Coefficient cc WHERE cc.rf_idCase=t.rf_idCase) AND AmountPayment>0
	--AND NOT EXISTS(SELECT 1 FROM dbo.t_Meduslugi mm WHERE mm.rf_idCase=t.rf_idCase AND mm.MUSurgery IN( 'A11.20.028','A11.20.036' ) )
GROUP BY ReportYear,CodeM
PRINT 'Col6'
