...
SELECT code,name 
INTO #csg
FROM dbo.vw_sprCSG WHERE code LIKE 'st12.%' AND dateBeg>='20190101' AND dateEnd<'20200101'
UNION all
SELECT code,name 
FROM dbo.vw_sprCSG WHERE code='st23.004' AND dateBeg>='20190101' AND dateEnd<'20200101'
