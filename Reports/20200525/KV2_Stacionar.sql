USE AccountOMS
GO
DECLARE @dateStartReg DATETIME='202000501',
...
FROM dbo.t_File f INNER JOIN dbo.t_RegistersAccounts a ON
			...
			c.id=dd.rf_idCase						
WHERE f.DateRegistration>=@dateStartReg AND f.DateRegistration<@dateEndReg  AND a.ReportYear=@reportYear /*AND a.ReportMonth>2  AND a.ReportMonth<@reportMonth */ AND a.ReportMonth=@reportMonth
AND c.rf_idV006=1
