...
FROM dbo.t_File f INNER JOIN dbo.t_RegistersAccounts a ON
            ...
            c.id=d.rf_idCase
WHERE f.DateRegistration>=@dateStart AND f.DateRegistration<@dateEnd  AND a.ReportYear=@reportYear AND a.rf_idSMO='34' AND a.Letter='O'
	AND d.TypeDisp IN('ÄÂ1','ÄÂ3')
