...
DECLARE @dateStartReg DATETIME='20200901',
		@dateEndReg DATETIME='20201216',
		@dateStartRegRAK DATETIME='20200901',
		@dateEndRegRAK DATETIME='20201216',
		@reportYear SMALLINT=2020,
		@reportMonth TINYINT=11

DECLARE @reportPeriod INT=202011
...
FROM #tCases c INNER join (SELECT m.rf_idCase ,SUM(m.Quantity) Quantity 
						   ...
						   WHERE m.MUGroupCode=4 AND (
														 (m.MUUnGroupCode=17 AND m.MUCode IN(785,786) ) OR (m.MUUnGroupCode=27 AND m.MUCode=1) 
													 ) 
